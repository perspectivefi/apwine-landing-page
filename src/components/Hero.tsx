    ...
    <div className="flex flex-col items-center text-white w-full max-w-2xl mx-auto mt-16 mb-32 md:mt-14 md:mb-24 px-8 md:px-0">
        ...
        */ }
        ...
        <div className="flex flex-col sm:flex-row items-center mt-8 text-sm space-y-2 sm:space-y-0 sm:space-x-2">
            <a href="https://app.apwine.fi" target="_blank" rel="noopener noreferrer" className="px-8 py-3 bg-gradient-to-br from-primary-300 to-primary-200 rounded-xl transition duration-300 hover:opacity-75">Enter platform</a>
            <a href="https://gov.apwine.fi" target="_blank" rel="noopener noreferrer" className="px-8 py-3 hover:text-primary-200 transition duration-300">Explore more</a>
        </div>
    </div>
)
